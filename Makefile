CC = g++
CFLAGS = -D _DEBUG -ggdb3 -std=c++17 -O0 -Wall -Wextra -Weffc++ -Wc++14-compat -Wmissing-declarations -Wcast-align -Wcast-qual \
         ...
         -Wno-old-style-cast -Wno-varargs -Wstack-protector -fsized-deallocation -fstack-protector -fstrict-overflow \
